...
export const CustomSelect: React.FC = () => {
    ...
    const selectState: SelectStateType[] = [
        {id: '1', title: 'React', description: 'React is a free and open-source front-end JavaScript library'},
        {
            id: '2',
            title: 'Redux',
            description: 'Redux is an open-source JavaScript library for managing and centralizing application state.'
        },
        {id: '3', title: 'HTML', description: 'HyperText Markup Language'},
        {id: '4', title: 'Axios', description: 'Axios is a promise-based HTTP Client for node.js and the browser. '},
        {
            id: '5',
            title: 'JavaScript',
